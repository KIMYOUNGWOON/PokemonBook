...
* 검색, 정렬, 다양한 옵션의 필터 등의 조건을 중첩 적용하여 세부적으로 찾을 수 있습니다.
* 나의 도감 리스트에 담아서 관리할 수 있습니다.
...
* 컬러 정의
  * 전체적으로 UI 통일감을 주기 위해 포켓몬 로고의 두 가지 색상으로 메인 컬러 사용 
  * 포켓몬의 각 속성 마다 배경 색상 및 폰트 색상을 객체로 정의
  * 각 속성을 쉽게 식별할 수 있도록 구현
 
* 인터렉션 UI 개발
  * 마우스 호버나 클릭시 애니메이션 효과 적용
...
* 포켓몬 상세 정보 가져오기
  ...
  * 데이터를 가져오는 동안 isLoading 상태에 따라 페이지에 로딩 스피너 표시
...
* 포켓몬 리스트 가져오기
  ...
  * 추가 불러오기 버튼 클릭 시 데이터를 가져오는 동안 버튼에 로딩 스피너 표시
